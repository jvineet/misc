...
public class Fox implements ArenaAnimal {
    ...
    protected static int INITIAL_ENERGY = 100;
    protected static int MAX_ENERGY = 120;
    protected static int STRENGTH = 100;
    protected static int VIEW_RANGE = 5;
    protected static int MIN_BREEDING_ENERGY = 20;
    protected static int COOLDOWN = 3;
    protected static ImageIcon foxImage = Util.loadImage("fox.gif");
