...
public interface Graph {
	 ...
	 * where each vertex adjacent to v appears exactly once. The size of the
	 * array must be as small as possible (No trailing null elements). This
	 * method should return an array of size 0 iff v has no neighbors.
	 */
	 ...
	 * This method should return an array of size 0 iff the graph has no
	 * vertices.
	 */
